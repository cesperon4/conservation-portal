/*
  ...
  - You are about to drop the `program_budget_log` table. If the table is not empty, all the data it contains will be lost.

*/
-- DropForeignKey
ALTER TABLE "program_budget_log" DROP CONSTRAINT "program_budget_log_program_id_fkey";

-- DropForeignKey
ALTER TABLE "program_budget_log" DROP CONSTRAINT "program_budget_log_user_id_fkey";

-- DropTable
DROP TABLE "program_budget_log";
